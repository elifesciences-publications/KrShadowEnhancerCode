%% Run SlopeBurstCalling for all data sets - generate structure of burst properties for all embryos approved in DataStatus sheet 
%load constructs
ConstructList= {'KrDist';'KrProx';'KrBothSep';'KrDistEmpty';'KrProxEmpty';'KrDistDuplicN';'KrProxDuplic';'Kr2xProxEmpty';'KrBoth';'KrBothEmpty';'KrDist32C';'KrProx32C';'KrBothSep32C';'KrBoth32C';'Kr2xProx32C';'Kr2xDist32C';'KrDist17C';'KrSEdBcd';'Kr2xDistdBcd';'Kr2xProxdHb';'KrProx17C';'KrBoth17C';'Kr2xDist17C';'Kr2xProx17C';'Kr2xDistEmpty';'KrEndogDist'} %{'KrBoth';'KrDist';'KrProx';'KrProxAtDist';...
