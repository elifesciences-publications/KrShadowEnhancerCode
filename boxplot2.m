function boxplot2(data,xlab,Mlab,colors)
...
if nargin>=2
    set(gca,'xticklabel',xlab, 'TickLabelInterpreter', 'tex','fontweight','bold','fontsize',10, 'FontName', 'Arial');
    set(gca, 'YScale', 'log','fontweight','bold','fontsize',10, 'FontName', 'Arial')
else
    idx=1:L;
